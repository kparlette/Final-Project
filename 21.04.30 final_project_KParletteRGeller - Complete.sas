...
/*Importing two predication variables*/

/*FILENAME REFFILE '/home/u58259531/EPG1V2/MTH752/Final Project/prediction variables.csv';
PROC IMPORT DATAFILE=REFFILE DBMS=CSV OUT=WORK.PREDICT replace;
	GETNAMES=YES;
	guessingrows=700;
RUN;*/
...
data predict3;
	format title $CHAR72.;
	input runtime2 best_pic_nom2 mpaa_ratings2 imdb_num_votes 
		critics_score top200_box2 title;
	cards;
...
data predict2;
	format title $CHAR72.;
	input runtime2 best_pic_nom2 mpaa_ratings2 imdb_num_votes 
		audience_rating2 top200_box2 best_actress_win2 thtr_rel_year2 
		imdb_rating thtr_rel_day2 title;
	cards;	
