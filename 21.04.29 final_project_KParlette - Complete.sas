...
data predict2;
	input Domestic_Box_Office=runtime2 best_pic_nom2 mpaa_ratings2 imdb_num_votes 
		audience_rating2 top200_box2 best_actress_win2 thtr_rel_year2 imdb_rating thtr_rel_day2;
	cards;
128 0 3 266088 1 0 0 2016 7.3 14
130 0 2 416952 1 1 0 2016 7.3 16
;
run;
